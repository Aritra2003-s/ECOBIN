...
const seed = async () => {
  try {
    ...
    // ── 2. Staff (12 Professional Drivers + Collectors & Supervisors) ─────────
    const staffMembers = await Staff.insertMany([
      ...
      },
      {
        ...
        email:        'amitabh.m@ecomanage.com',
        licenseNumber: 'WB-0120230089124',
        availability:  'available',
        shiftTiming:   { start: '06:00 AM', end: '02:00 PM' },
        joiningDate:   daysAgo(310),
        isActive:      true,
        performanceRating: 4.9,
        totalPickupsCompleted: 168,
      },
      {
        ...
        email:        'subhash.c@ecomanage.com',
        licenseNumber: 'WB-0120230012345',
        availability:  'available',
        shiftTiming:   { start: '08:00 AM', end: '04:00 PM' },
        joiningDate:   daysAgo(280),
        isActive:      true,
        performanceRating: 4.6,
        totalPickupsCompleted: 114,
      },
      {
        name:         'Rameshwar Gupta',
        employeeId:   'EMP005',
        role:         'driver',
        phone:        '+91 70000 10005',
        email:        'rameshwar.g@ecomanage.com',
        licenseNumber: 'WB-0120230034567',
        availability:  'available',
        shiftTiming:   { start: '06:00 AM', end: '02:00 PM' },
        joiningDate:   daysAgo(410),
        isActive:      true,
        performanceRating: 4.8,
        totalPickupsCompleted: 195,
      },
      {
        name:         'Vikramaditya Roy',
        employeeId:   'EMP006',
        role:         'driver',
        phone:        '+91 70000 10006',
        email:        'vikramaditya.r@ecomanage.com',
        licenseNumber: 'WB-0120230056789',
        availability:  'available',
        shiftTiming:   { start: '02:00 PM', end: '10:00 PM' },
        joiningDate:   daysAgo(150),
        isActive:      true,
        performanceRating: 4.9,
        totalPickupsCompleted: 76,
      },
      {
        name:         'Arjun Sen',
        employeeId:   'EMP007',
        role:         'driver',
        phone:        '+91 70000 10007',
        email:        'arjun.sen@ecomanage.com',
        licenseNumber: 'WB-0120230078901',
        availability:  'available',
        shiftTiming:   { start: '07:00 AM', end: '03:00 PM' },
        joiningDate:   daysAgo(190),
        isActive:      true,
        performanceRating: 4.5,
        totalPickupsCompleted: 98,
      },
      {
        name:         'Devendra Prasad',
        employeeId:   'EMP008',
        role:         'driver',
        phone:        '+91 70000 10008',
        email:        'devendra.p@ecomanage.com',
        licenseNumber: 'WB-0120230090123',
        availability:  'available',
        shiftTiming:   { start: '06:00 AM', end: '02:00 PM' },
        joiningDate:   daysAgo(520),
        isActive:      true,
        performanceRating: 4.7,
        totalPickupsCompleted: 230,
      },
      {
        name:         'Kalyan Banerjee',
        employeeId:   'EMP009',
        role:         'driver',
        phone:        '+91 70000 10009',
        email:        'kalyan.b@ecomanage.com',
        licenseNumber: 'WB-0120230023456',
        availability:  'available',
        shiftTiming:   { start: '08:00 AM', end: '04:00 PM' },
        joiningDate:   daysAgo(90),
        isActive:      true,
        performanceRating: 4.6,
        totalPickupsCompleted: 45,
      },
      {
        name:         'Gurpreet Singh',
        employeeId:   'EMP010',
        role:         'driver',
        phone:        '+91 70000 10010',
        email:        'gurpreet.s@ecomanage.com',
        licenseNumber: 'WB-0120230045678',
        availability:  'available',
        shiftTiming:   { start: '06:00 AM', end: '02:00 PM' },
        joiningDate:   daysAgo(340),
        isActive:      true,
        performanceRating: 4.9,
        totalPickupsCompleted: 182,
      },
      {
        name:         'Pradeep Sharma',
        employeeId:   'EMP011',
        role:         'driver',
        phone:        '+91 70000 10011',
        email:        'pradeep.s@ecomanage.com',
        licenseNumber: 'WB-0120230067891',
        availability:  'available',
        shiftTiming:   { start: '01:00 PM', end: '09:00 PM' },
        joiningDate:   daysAgo(220),
        isActive:      true,
        performanceRating: 4.8,
        totalPickupsCompleted: 125,
      },
      {
        name:         'Manoj Halder',
        employeeId:   'EMP012',
        role:         'driver',
        phone:        '+91 70000 10012',
        email:        'manoj.h@ecomanage.com',
        licenseNumber: 'WB-0120230089012',
        availability:  'available',
        shiftTiming:   { start: '06:00 AM', end: '02:00 PM' },
        joiningDate:   daysAgo(110),
        isActive:      true,
        performanceRating: 4.7,
        totalPickupsCompleted: 62,
      },
      {
        name:         'Deepa Roy',
        employeeId:   'EMP013',
        role:         'collector',
        phone:        '+91 70000 10013',
        availability:  'available',
        shiftTiming:   { start: '06:00 AM', end: '02:00 PM' },
    ...
    const [
      rajesh, mohan, amitabh, subhash,
      rameshwar, vikramaditya, arjun, devendra,
      kalyan, gurpreet, pradeep, manoj,
      deepa, vikram
    ] = staffMembers;
    console.log(`👷 Created ${staffMembers.length} staff members (12 professional drivers)`);

    // ── 3. Vehicles (12 Municipal Fleet Trucks & Vans) ─────────────────────────
    const vehicles = await Vehicle.insertMany([
      ...
      {
        registrationNumber: 'WB-02-IJ-7890',
        type:          'compactor',
        model:         'Eicher Pro 3015 Compactor',
        manufacturer:  'Eicher Motors',
        year:          2022,
        capacity:      { value: 9500, unit: 'kg' },
        fuelType:      'cng',
        status:        'available',
      ...
      {
        registrationNumber: 'WB-02-KL-2345',
        type:          'recycling_van',
        model:         'Tata Ace Gold Eco',
        manufacturer:  'Tata Motors',
        year:          2023,
        ...
        status:        'available',
        currentMileage: 9400,
        lastServiced:   daysAgo(10),
        nextServiceDue: daysFromNow(80),
        isActive:      true,
      },
      {
        registrationNumber: 'WB-02-MN-6789',
        type:          'large_truck',
        model:         'BharatBenz 1917 Tipper',
        manufacturer:  'Daimler India',
        year:          2021,
        capacity:      { value: 14000, unit: 'kg' },
        fuelType:      'diesel',
        status:        'available',
        currentMileage: 54000,
        lastServiced:   daysAgo(25),
        nextServiceDue: daysFromNow(50),
        isActive:      true,
      },
      {
        registrationNumber: 'WB-02-OP-0123',
        type:          'compactor',
        model:         'Ashok Leyland Ecomet Star',
        manufacturer:  'Ashok Leyland',
        year:          2022,
        capacity:      { value: 8500, unit: 'kg' },
        fuelType:      'cng',
        status:        'available',
        currentMileage: 36800,
        lastServiced:   daysAgo(18),
        nextServiceDue: daysFromNow(75),
        isActive:      true,
      },
      {
        registrationNumber: 'WB-02-QR-4567',
        type:          'recycling_van',
        model:         'Mahindra Bolero Maxi Truck',
        manufacturer:  'Mahindra',
        year:          2021,
        capacity:      { value: 2200, unit: 'kg' },
        fuelType:      'diesel',
        status:        'available',
        currentMileage: 48900,
        lastServiced:   daysAgo(40),
        nextServiceDue: daysFromNow(30),
        isActive:      true,
      },
      {
        registrationNumber: 'WB-02-ST-8901',
        type:          'large_truck',
        model:         'Tata Prima 2830 Heavy Hauler',
        manufacturer:  'Tata Motors',
        year:          2020,
        capacity:      { value: 16000, unit: 'kg' },
        fuelType:      'diesel',
        status:        'available',
        currentMileage: 76500,
        lastServiced:   daysAgo(12),
        nextServiceDue: daysFromNow(48),
        isActive:      true,
      },
      {
        registrationNumber: 'WB-02-UV-2345',
        type:          'recycling_van',
        model:         'Force Urbania Clean Sweep',
        manufacturer:  'Force Motors',
        year:          2023,
        capacity:      { value: 2800, unit: 'kg' },
        fuelType:      'electric',
        status:        'available',
        currentMileage: 7300,
        lastServiced:   daysAgo(5),
        nextServiceDue: daysFromNow(95),
        isActive:      true,
      },
      {
        registrationNumber: 'WB-02-WX-6789',
        type:          'compactor',
        model:         'Tata Ultra T.7 Compactor',
        manufacturer:  'Tata Motors',
        year:          2022,
        capacity:      { value: 7500, unit: 'kg' },
        fuelType:      'cng',
        status:        'available',
        currentMileage: 28400,
        lastServiced:   daysAgo(14),
        nextServiceDue: daysFromNow(65),
        isActive:      true,
      },
    ]);

    const [
      compactor, largeTruck, recyclingVan, hazmat,
      eicherCompactor, tataAceEco, bharatBenzTipper, ecometCompactor,
      boleroVan, tataPrima, urbaniaVan, ultraT7
    ] = vehicles;
    console.log(`🚛 Created ${vehicles.length} vehicles (12 municipal fleet units)`);
